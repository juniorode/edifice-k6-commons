...
const E = __ENV.BASE_URL, D = 30 * 60, k = __ENV.ROOT_URL, l = function(o) {
  let e;
...
}, d = __ENV.ROOT_URL, A = new I(d).hostname;
function y(o, e) {
...
function de(o, e, r) {
  const t = c.post(
    `${N}/communication/v2/group/${o}/communique/${e}`,
    "{}",
    { headers: l(r) }
  );
